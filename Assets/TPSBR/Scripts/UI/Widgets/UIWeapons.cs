...
namespace TPSBR.UI
{
	public class UIWeapons : UIBehaviour
	{
		...
		[SerializeField]
		private TextMeshProUGUI _secondaryThumbnailText;
		[SerializeField]
		private CanvasGroup _primaryThumbnail;
		[SerializeField]
		private TextMeshProUGUI _primaryThumbnailText;
		[SerializeField]
		...
		private void UpdateThumbnails(Weapons weapons, AgentInput agentInput)
		{
			...
			UpdateWeaponThumbnail(weapons, _secondaryThumbnail, _secondaryThumbnailText, 1, ref _lastSecondaryID);
			UpdateWeaponThumbnail(weapons, _primaryThumbnail, _primaryThumbnailText, 2, ref _lastPrimaryID);
		...
		private void UpdateWeaponThumbnail(Weapons weapons, CanvasGroup thumbnail, TextMeshProUGUI weaponName, int weaponSlot, ref NetworkId lastWeaponID)
		{
			...
			weaponName.text = weapon.NameShortcut.HasValue() == false ? weapon.DisplayName.Substring(0, 4) : weapon.NameShortcut;
